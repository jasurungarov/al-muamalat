						...
						<div className='grid grid-cols-1 md:grid-cols-2'>
							<div>
								<Link href={'/programs'}>
									<Button
										size={'lg'}
										className='bg-[#d28527] hover:bg-black text-white'
									>
										<p className='ml-0'>STUDENTS` OPNION</p>
									</Button>
								</Link>
							</div>
							<div className='mt-0.5 md:-ml-30'>
								<Image
									src={'/reviews.png'}
									alt='hero'
									width={170}
