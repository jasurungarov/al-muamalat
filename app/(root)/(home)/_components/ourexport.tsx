...
export default function OurExporte() {
  ...
  return (
    <div className="relative container mx-auto w-full py-24 px-4 sm:px-6 lg:px-8">
      {/* 'relative' container qo‘shildi */}
      <h1 className="text-center text-3xl sm:text-4xl md:text-5xl font-bold">Our Expert Team</h1>
      ...
      <div className="relative flex items-center justify-center mt-10 h-[350px] sm:h-[400px] lg:h-[450px]">
        {experts.map((item, index) => {
          ...
          return (
            <motion.div
              ...
              className={clsx(
                'absolute w-full sm:w-[700px] rounded-2xl bg-[#d6e6e4] p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2',
                blur
              )}
              style={{ zIndex: pIndex }}
            >
